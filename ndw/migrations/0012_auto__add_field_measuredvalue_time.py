...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeasuredValue.time'
        db.add_column(u'ndw_measuredvalue', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeasuredValue.time'
        db.delete_column(u'ndw_measuredvalue', 'time')
