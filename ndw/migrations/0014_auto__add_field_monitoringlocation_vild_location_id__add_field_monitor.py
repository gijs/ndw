...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonitoringLocation.vild_location_id'
        db.add_column(u'ndw_monitoringlocation', 'vild_location_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MonitoringLocation.vild_location_offset'
        db.add_column(u'ndw_monitoringlocation', 'vild_location_offset',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MonitoringLocation.vild_location_id'
        db.delete_column(u'ndw_monitoringlocation', 'vild_location_id')

        # Deleting field 'MonitoringLocation.vild_location_offset'
        db.delete_column(u'ndw_monitoringlocation', 'vild_location_offset')
    ...
    models = {
        ...
        u'ndw.monitoringlocation': {
            ...
            'vild_location_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'vild_location_offset': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'ndw.vehicleclass': {
