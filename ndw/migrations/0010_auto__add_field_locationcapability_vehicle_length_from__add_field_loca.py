...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationCapability.vehicle_length_from'
        db.add_column(u'ndw_locationcapability', 'vehicle_length_from',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'LocationCapability.vehicle_length_to'
        db.add_column(u'ndw_locationcapability', 'vehicle_length_to',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationCapability.vehicle_length_from'
        db.delete_column(u'ndw_locationcapability', 'vehicle_length_from')

        # Deleting field 'LocationCapability.vehicle_length_to'
        db.delete_column(u'ndw_locationcapability', 'vehicle_length_to')
