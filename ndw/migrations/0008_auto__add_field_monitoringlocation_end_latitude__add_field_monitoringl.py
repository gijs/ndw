...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonitoringLocation.end_latitude'
        db.add_column(u'ndw_monitoringlocation', 'end_latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'MonitoringLocation.end_longitude'
        db.add_column(u'ndw_monitoringlocation', 'end_longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'MonitoringLocation.length_affected'
        db.add_column(u'ndw_monitoringlocation', 'length_affected',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MonitoringLocation.end_latitude'
        db.delete_column(u'ndw_monitoringlocation', 'end_latitude')

        # Deleting field 'MonitoringLocation.end_longitude'
        db.delete_column(u'ndw_monitoringlocation', 'end_longitude')

        # Deleting field 'MonitoringLocation.length_affected'
        db.delete_column(u'ndw_monitoringlocation', 'length_affected')
